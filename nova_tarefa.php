<html>
	<head>
		...
		<link rel="stylesheet" href="arquivocss/estilo.css">
	...
	<body>
		...
		<div class="container mt-5">
			<div class="row">
				...
				<div class="col-md-9 border rounded shadow p-3">
					<div class="container">
						<div class="row">
							<div class="col">
								<h4>Nova tarefa</h4>
								...
								<form method="post" action="controladorDados.php?acao=inserir">
								...
								<?php require "mensagem_cadastro.php"; ?>
							</div>
						</div>
					</div>
				</div>
